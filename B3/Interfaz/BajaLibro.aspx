<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="BajaLibro.aspx.cs" Inherits="B3.Interfaz.BajaLibro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    <form id="Form1" runat="server">
        ...
        <div class="titulo">Dar de baja Libro</div>
        <br/>
        <table>
            <tr>
